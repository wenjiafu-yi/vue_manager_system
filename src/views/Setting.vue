<template>
  <div class="warper">
    <div class="ms-doc">
      ...
      <article>
        <h1>manage-system</h1>
        <p>基于Vuecli 3.0.5 + Element UI + Node.js + MySQL的登录管理系统</p>
        <h2>前言</h2>
        <p>用了Vue + Element组件库做了个登录管理系统，包括登录，数据中心几个功能模块。</p>
        ...
        <br />
        <h2>安装步骤</h2>
        <p>cd vue-manager-system //进入项目目录</p>
        ...
        <p>即请求/api时就代表http://127.0.0.1:8089/api/(这里要写ip，不要写localhost)，changeOrigin参数接收一个布尔值，如果为true，这样就不会有跨域问题了。</p>
        <h2>最终项目的目录结构</h2>
        <div>
          <img src alt />
        </div>
